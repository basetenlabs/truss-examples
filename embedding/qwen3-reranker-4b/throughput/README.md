...
With `11-embeddings-reranker-classification-tensorrt/BEI-qwen-qwen3-reranker-4b-fp8` as your working directory, you can deploy the model with the following command. Run `baseten auth login` first if the CLI is not authenticated.
