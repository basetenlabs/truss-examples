...
class Model:
    ...
    def load(self):
        ...
        self.pipe = pipeline_module.FluxPipeline.FromArgs(
            self.args, pipeline_type=pipeline_module.PIPELINE_TYPE.TXT2IMG
        )
    ...
    def _create_args(self) -> argparse.Namespace:
        ...
        default_args = [
            ...
            "--onnx-dir",
            "/app/data/onnx",  # Directory for ONNX files
            "--engine-dir",
            "/app/data/engine",  # Directory for TensorRT engines
            "--custom-engine-paths",
            ...
            "42",
            "--framework-model-dir",
            "/app/data",  # Point to the directory containing the model files
        ]
    ...
    def predict(self, model_input: Any) -> Any:
        ...
        if (
            height != self.args.height
            or width != self.args.width
            or batch_size != self.args.batch_size
        ):
        ...
        try:
            ...
            print(
                f"[I] Generated {len(processed_images)} images in {end_time:.2f} seconds"
            )
