...
This is a [Truss](https://truss.baseten.co/) for an FP8 version of LLaMA3-8B-Instruct. Llama is a family of language models released by Meta. This README will walk you through how to deploy this Truss on Baseten to get your own instance of LLaMA3-8B-Instruct.
...
## Deploying LLaMA3-8B-Instruct

First, clone this repository:

```sh
git clone https://github.com/basetenlabs/truss-examples/
cd llama/llama-3-8b-instruct-trt-llm-fp8
```
...
With `llama-3-8b-instruct-trt-llm-fp8` as your working directory, you can deploy the model with:
...
## LLaMA3-8B API documentation

This section provides an overview of the LLaMA3-8B API, its parameters, and how to use it. The API consists of a single route named `predict`, which you can invoke to generate text based on the provided instruction.
