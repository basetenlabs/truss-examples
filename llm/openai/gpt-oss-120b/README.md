...
Deploy [openai/gpt-oss-120b](https://huggingface.co/openai/gpt-oss-120b) for text generation using a TRT-LLM engine on Baseten.
...
curl -X POST https://model-<model_id>.api.baseten.co/v1/chat/completions \
  ...
  -d '{"model": "openai/gpt-oss-120b", "messages": [{"role": "user", "content": "What is machine learning?"}], "max_tokens": 512}'
```
