...
Deploy [Qwen/Qwen2.5-32B-Instruct](https://huggingface.co/Qwen/Qwen2.5-32B-Instruct) for text generation using a TRT-LLM engine on Baseten.
...
curl -X POST https://model-<model_id>.api.baseten.co/v1/chat/completions \
  ...
  -d '{"model": "Qwen/Qwen2.5-32B-Instruct", "messages": [{"role": "user", "content": "What is machine learning?"}], "max_tokens": 512}'
```
