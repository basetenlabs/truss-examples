# library-model-qwen3-06b-engine

Deploy [Qwen/Qwen3-0.6B](https://huggingface.co/Qwen/Qwen3-0.6B) for text generation using a TRT-LLM engine on Baseten.
...
curl -X POST https://model-<model_id>.api.baseten.co/v1/chat/completions \
  ...
  -d '{"model": "Qwen/Qwen3-0.6B", "messages": [{"role": "user", "content": "What is machine learning?"}], "max_tokens": 512}'
```
