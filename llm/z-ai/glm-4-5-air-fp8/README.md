...
Deploy [zai-org/GLM-4.5-Air-FP8](https://huggingface.co/zai-org/GLM-4.5-Air-FP8) for text generation using a SGLang engine on Baseten.
...
curl -X POST https://model-<model_id>.api.baseten.co/v1/chat/completions \
  ...
  -d '{"model": "zai-org/GLM-4.5-Air-FP8", "messages": [{"role": "user", "content": "What is machine learning?"}], "max_tokens": 512}'
```
