"""Batch truss for nvidia/Nemotron-3-Diarization (NeMo streaming Sortformer; OpenMDW-1.1).

Loads the .nemo checkpoint, runs whole-file diarization, returns speaker turns ({start, end, speaker}) + raw segments.
