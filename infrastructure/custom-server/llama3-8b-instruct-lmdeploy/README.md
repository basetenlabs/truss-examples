# Llama 3.1 8B Instruct LMDeploy

Deploy [meta-llama/Llama-3.1-8B-Instruct](https://huggingface.co/meta-llama/Llama-3.1-8B-Instruct) using a custom server configuration on Baseten.
...
curl -X POST https://model-<model_id>.api.baseten.co/v1/completions \
  ...
  -d '{"model": "meta-llama/Llama-3.1-8B-Instruct", "prompt": "What is the capital of France?", "max_tokens": 256}'
```
