...
class TritonClient:
    ...
    def build_server_start_command(
        ...
        return self.get_cmd(
            ...
            model_repo=str(self._model_repository_dir),
        )

    def get_cmd(
        self,
        world_size: int = 1,
        tritonserver: str = "/opt/tritonserver/bin/tritonserver",
        model_repo: str = "/packages/inflight_batcher_llm/",
        grpc_port: int = 8001,
        http_port: int = 8000,
        ...
        return mpirun_command + mpi_commands
