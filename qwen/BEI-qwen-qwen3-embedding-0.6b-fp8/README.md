...
# Examples:
This deployment is specifically designed for the Hugging Face model [Qwen/Qwen3-Embedding-0.6B](https://huggingface.co/Qwen/Qwen3-Embedding-0.6B).
...
Qwen/Qwen3-Embedding-0.6B  is a text-embeddings model, producing a 1D embeddings vector, given an input.
