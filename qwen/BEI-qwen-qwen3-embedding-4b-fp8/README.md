...
# Examples:
This deployment is specifically designed for the Hugging Face model [Qwen/Qwen3-Embedding-4B](https://huggingface.co/Qwen/Qwen3-Embedding-4B).
...
Qwen/Qwen3-Embedding-4B  is a text-embeddings model, producing a 1D embeddings vector, given an input.
