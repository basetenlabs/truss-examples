# BEI (Baseten-Embeddings-Inference) with Qwen/Qwen3-Reranker-4B
...
# Examples:
This deployment is specifically designed for the Hugging Face model [Qwen/Qwen3-Reranker-4B](https://huggingface.co/Qwen/Qwen3-Reranker-4B).
...
Qwen/Qwen3-Reranker-4B  is a text-embeddings model, producing a 1D embeddings vector, given an input.
