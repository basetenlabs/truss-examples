...
from model.scripts.util.detection.nsfw_and_watermark_dectection import (
...
def sample(
    ...
    if version == "svd":
        ...
        model_config = "model/scripts/sampling/configs/svd.yaml"
    elif version == "svd_xt":
    ...
    print("all models loaded succcessfully!!!!")
