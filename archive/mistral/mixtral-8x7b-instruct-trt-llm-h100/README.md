...
**Warning: This example is intended for usage on two H100s, changing your resource type for this deployment will result in unsupported behavior**
...
cd mixtral-8x7b-instruct-trt-llm-h100
```
...
With `mixtral-8x7b-instruct-trt-llm-h100` as your working directory, you can deploy the model with:
