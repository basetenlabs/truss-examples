...
|---------|---------|-------------------|
| [vllm-backend](./vllm-backend/) | [vLLM backend](https://docs.nvidia.com/deeplearning/triton-inference-server/user-guide/docs/vllm_backend/README.html) | `llama-3.2-1b-instruct` |
