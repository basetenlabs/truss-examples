...
from model.magicanimate.pipelines.pipeline_animation import AnimationPipeline
from model.magicanimate.utils.util import save_videos_grid
...
class MagicAnimate:
    def __init__(self, config="model/configs/prompts/animation.yaml") -> None:
