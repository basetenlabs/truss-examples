...
Deploy [sentence-transformers/all-MiniLM-L6-v2](https://huggingface.co/sentence-transformers/all-MiniLM-L6-v2) for generating text embeddings using a BEI (TensorRT) engine on Baseten.
