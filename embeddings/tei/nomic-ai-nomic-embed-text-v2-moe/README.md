...
Deploy [nomic-ai/nomic-embed-text-v2-moe](https://huggingface.co/nomic-ai/nomic-embed-text-v2-moe) for generating text embeddings using a TEI (HuggingFace) engine on Baseten.
