...
Deploy [jinaai/jina-embeddings-v2-base-code](https://huggingface.co/jinaai/jina-embeddings-v2-base-code) for generating text embeddings using a TEI (HuggingFace) engine on Baseten.
