# Alibaba-NLP GTE ModernBERT Base Embedding

Deploy [Alibaba-NLP/gte-modernbert-base](https://huggingface.co/Alibaba-NLP/gte-modernbert-base) for generating text embeddings using a TEI (HuggingFace) engine on Baseten.
...
curl -X POST https://model-<model_id>.api.baseten.co/v1/embeddings \
  ...
  -d '{"input": "What is deep learning?", "model": "Alibaba-NLP/gte-modernbert-base"}'
```
