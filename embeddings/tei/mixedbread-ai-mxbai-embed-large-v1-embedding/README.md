...
Deploy [mixedbread-ai/mxbai-embed-large-v1](https://huggingface.co/mixedbread-ai/mxbai-embed-large-v1) for generating text embeddings using a TEI (HuggingFace) engine on Baseten.
