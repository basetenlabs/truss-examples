...
Deploy [redis/langcache-embed-v2](https://huggingface.co/redis/langcache-embed-v2) for generating text embeddings using a TEI (HuggingFace) engine on Baseten.
