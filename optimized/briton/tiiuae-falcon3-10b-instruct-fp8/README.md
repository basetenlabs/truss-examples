# Briton-tiiuae-falcon3-10b-instruct-fp8-truss-example
...
curl -X POST https://model-<model_id>.api.baseten.co/v1/chat/completions \
  ...
  -d '{"model": "tiiuae/Falcon3-10B-Instruct", "messages": [{"role": "user", "content": "What is machine learning?"}], "max_tokens": 512}'
```
