...
Deploy [meta-llama/Llama-3.1-405B](https://huggingface.co/meta-llama/Llama-3.1-405B) for text generation using a TRT-LLM engine on Baseten.
...
curl -X POST https://model-<model_id>.api.baseten.co/v1/chat/completions \
  ...
  -d '{"model": "meta-llama/Llama-3.1-405B", "messages": [{"role": "user", "content": "What is machine learning?"}], "max_tokens": 512}'
```
