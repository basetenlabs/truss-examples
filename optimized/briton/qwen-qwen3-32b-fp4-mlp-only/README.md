# Briton-qwen-qwen3-32b-fp4-mlp-only-truss-example

Deploy [Qwen/Qwen3-32B](https://huggingface.co/Qwen/Qwen3-32B) for text generation using a TRT-LLM engine on Baseten.
...
curl -X POST https://model-<model_id>.api.baseten.co/v1/chat/completions \
  ...
  -d '{"model": "Qwen/Qwen3-32B", "messages": [{"role": "user", "content": "What is machine learning?"}], "max_tokens": 512}'
```
