# Orpheus-3b Best Performance

Deploy Orpheus-3b Best Performance on Baseten using a TRT-LLM engine.

| Property | Value |
|----------|-------|
| Model | [canopylabs/orpheus-3b-0.1-ft](https://huggingface.co/canopylabs/orpheus-3b-0.1-ft) |
| Task | Audio |
| Engine | TRT-LLM |
| GPU | H100_40GB |
| Quantization | FP8 KV |
