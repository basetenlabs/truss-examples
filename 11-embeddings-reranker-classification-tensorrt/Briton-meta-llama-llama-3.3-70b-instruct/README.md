...
cd 11-embeddings-reranker-classification-tensorrt/Briton-meta-llama-llama-3.3-70b-instruct
```

With `11-embeddings-reranker-classification-tensorrt/Briton-meta-llama-llama-3.3-70b-instruct` as your working directory, you can deploy the model with the following command. Paste your Baseten API key if prompted.

```sh
truss push --publish
# prints:
# ✨ Model Briton-meta-llama-llama-3.3-70b-instruct-truss-example was successfully pushed ✨
...
model_metadata:
  example_model_input:
    ...
    - content: Tell me everything about Baseten.co!
      role: user
    temperature: 0.3
model_name: Briton-meta-llama-llama-3.3-70b-instruct-truss-example
python_version: py39
requirements: []
resources:
  accelerator: H100
