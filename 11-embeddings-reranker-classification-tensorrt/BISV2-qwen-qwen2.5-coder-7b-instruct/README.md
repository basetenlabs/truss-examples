# Baseten Inference Stack with Qwen/Qwen2.5-Coder-7B-Instruct

This is a Deployment for Baseten Inference Stack with Qwen/Qwen2.5-Coder-7B-Instruct. Baseten Inference Stack is Baseten's solution for production-grade deployments via TensorRT-LLM for Causal Language Models models. (e.g. LLama, Qwen, Mistral)
