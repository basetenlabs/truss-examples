...
This is a Deployment for BEI (Baseten-Embeddings-Inference) with Salesforce/SFR-Embedding-Mistral. BEI is Baseten's solution for production-grade deployments via TensorRT-LLM.
