...
This is a Deployment for BEI (Baseten-Embeddings-Inference) with intfloat/e5-mistral-7b-instruct-embedding. BEI is Basetens soution for production-grade deployments via TensorRT-LLM. 
...
This deployment is specifically designed for the huggingface model [intfloat/e5-mistral-7b-instruct](https://huggingface.co/intfloat/e5-mistral-7b-instruct).
...
intfloat/e5-mistral-7b-instruct  is a text-embeddings model, producing a 1D-embeddings vector, given an output. 
