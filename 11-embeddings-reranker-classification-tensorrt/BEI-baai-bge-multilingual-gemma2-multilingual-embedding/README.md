...
This is a Deployment for BEI (Baseten-Embeddings-Inference) with BAAI/bge-multilingual-gemma2-multilingual-embedding. BEI is Basetens soution for production-grade deployments via TensorRT-LLM. 
...
This deployment is specifically designed for the huggingface model [BAAI/bge-multilingual-gemma2](https://huggingface.co/BAAI/bge-multilingual-gemma2).
It might be also working for other models that have the architecture of Gemma2Model specificied in their huggingface transformers config.
...
BAAI/bge-multilingual-gemma2  is a text-embeddings model, producing a 1D-embeddings vector, given an output. 
