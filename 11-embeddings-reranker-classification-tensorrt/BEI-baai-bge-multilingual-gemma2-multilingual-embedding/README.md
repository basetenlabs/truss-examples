# BEI (Baseten-Embeddings-Inference) with BAAI/bge-multilingual-gemma2-multilingual-embedding

This is a Deployment for BEI (Baseten-Embeddings-Inference) with BAAI/bge-multilingual-gemma2-multilingual-embedding. BEI is Baseten's solution for production-grade deployments via TensorRT-LLM for (text) embeddings, reranking models and prediction models.
