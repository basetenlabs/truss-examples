# TensorRT-LLM Briton with meta-llama/Llama-3.2-1B-Instruct

This is a Deployment for TensorRT-LLM Briton with meta-llama/Llama-3.2-1B-Instruct. Briton is Baseten's solution for production-grade deployments via TensorRT-LLM for Causal Language Models models. (e.g. LLama, Qwen, Mistral)
...
# Examples:
This deployment is specifically designed for the Hugging Face model [meta-llama/Llama-3.2-1B-Instruct](https://huggingface.co/meta-llama/Llama-3.2-1B-Instruct).
...
meta-llama/Llama-3.2-1B-Instruct  is a text-generation model, used to generate text given a prompt. \nIt is frequently used in chatbots, text completion, structured output and more.
...
cd 11-embeddings-reranker-classification-tensorrt/Briton-meta-llama-llama-3.2-1b-instruct
```

With `11-embeddings-reranker-classification-tensorrt/Briton-meta-llama-llama-3.2-1b-instruct` as your working directory, you can deploy the model with the following command. Paste your Baseten API key if prompted.

```sh
truss push --publish
# prints:
# ✨ Model Briton-meta-llama-llama-3.2-1b-instruct-truss-example was successfully pushed ✨
...
model_metadata:
  ...
  tags:
  - openai-compatible
model_name: Briton-meta-llama-llama-3.2-1b-instruct-truss-example
python_version: py39
requirements: []
resources:
  accelerator: L4
