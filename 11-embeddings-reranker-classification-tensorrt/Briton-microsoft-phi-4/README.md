...
cd 11-embeddings-reranker-classification-tensorrt/Briton-microsoft-phi-4
```

With `11-embeddings-reranker-classification-tensorrt/Briton-microsoft-phi-4` as your working directory, you can deploy the model with the following command. Paste your Baseten API key if prompted.

```sh
truss push --publish
# prints:
# ✨ Model Briton-microsoft-phi-4-truss-example was successfully pushed ✨
...
model_metadata:
  example_model_input:
    ...
    - content: Tell me everything about Baseten.co!
      role: user
    temperature: 0.3
model_name: Briton-microsoft-phi-4-truss-example
python_version: py39
requirements: []
resources:
  accelerator: L4
