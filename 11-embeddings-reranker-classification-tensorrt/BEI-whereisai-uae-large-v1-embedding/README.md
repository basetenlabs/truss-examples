# BEI (Baseten-Embeddings-Inference) with WhereIsAI/UAE-Large-V1-embedding

This is a Deployment for BEI (Baseten-Embeddings-Inference) with WhereIsAI/UAE-Large-V1-embedding. BEI is Baseten's solution for production-grade deployments via TensorRT-LLM for (text) embeddings, reranking models and prediction models.
