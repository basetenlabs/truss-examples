# Baseten-Embeddings-Inference with BAAI/bge-reranker-v2-m3-multilingual

This is a Deployment for BEI (Baseten-Embeddings-Inference) with BAAI/bge-reranker-v2-m3-multilingual. BEI is Baseten's solution for production-grade deployments via TensorRT-LLM.
