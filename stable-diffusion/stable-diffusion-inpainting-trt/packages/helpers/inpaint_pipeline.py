...
from helpers.utilities import TRT_LOGGER, prepare_mask_and_masked_image
...
class InpaintPipeline(StableDiffusionPipeline):
    ...
    def infer(
        ...
        with torch.inference_mode(), torch.autocast("cuda"), trt.Runtime(TRT_LOGGER):
            ...
            mask, masked_image = self.preprocess_images(
                batch_size, prepare_mask_and_masked_image(input_image, mask_image)
            )
            ...
            if not warmup:
                ...
                return self.save_image(images, "inpaint", prompt)
