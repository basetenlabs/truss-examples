# MODEL_ID= OPENAI_API_KEY= python3 llama3_eval.py --task gsm8k
import argparse
import asyncio
import os
import pickle
...
def get_client(provider):
    ...
    print(f"https://model-{os.getenv('MODEL_ID')}.api.baseten.co/development/predict")
    return {
        "b10": AsyncOpenAI(
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--provider", type=str, default="b10", help="Provider name (e.g., b10)"
    )
    parser.add_argument(
        "--task",
        type=str,
    ...
    parser.add_argument(
        "--output-dir", type=str, default="tmp", help="Directory to save responses"
    )
